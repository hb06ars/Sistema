...
public class SistemaController extends HttpServlet {
	...
	public void deslogar(HttpServletRequest request, HttpServletResponse response) throws IOException { //Fun��o e alguns valores que recebe...
	...
	public ModelAndView login(HttpServletRequest request, HttpServletResponse response ) { //Fun��o e alguns valores que recebe...
	...
	public ModelAndView logar(HttpServletRequest request, HttpServletResponse response, String usuarioVal, String senhaVal) { //Fun��o e alguns valores que recebe...
		...
		if(usuarioVal != null || senhaVal != null) {
			...
			if(usuario != null && usuario.getID() != null) {
				...
				boasVindas = "Olá " + usuarioSessao.getNome() + "!";
				logado = true;
				link = "/pages/home";
	...
	public ModelAndView vendas(HttpServletRequest request, HttpServletResponse response, @RequestParam(value = "nome", required = false, defaultValue = "Henrique Brand�o") String nome) { //Fun��o e alguns valores que recebe...
		String link = "/pages/deslogar";
		ModelAndView modelAndView = new ModelAndView(link);
		HttpSession session = request.getSession();
		String atualizarPagina = "";
	...
	public ModelAndView todasVendas(HttpServletRequest request, HttpServletResponse response, String nota, String pesquisarVendaID) { //Fun��o e alguns valores que recebe...
		String link = "/pages/deslogar";
		HttpSession session = request.getSession();
		ModelAndView modelAndView = new ModelAndView(link);
		String atualizarPagina = "";
	...
	public ModelAndView funcionarios(HttpServletRequest request, HttpServletResponse response, @RequestParam(value = "nome", required = false, defaultValue = "Henrique Brand�o") String nome) { //Fun��o e alguns valores que recebe...
		String link = "/pages/deslogar";
		HttpSession session = request.getSession();
		ModelAndView modelAndView = new ModelAndView(link);
		Usuario usuarioSessao = new Usuario();
		...
		if(usuarioSessao != null && usuarioSessao.getID() != null) {
			link = "/pages/funcionarios"; //Session
			modelAndView = new ModelAndView(link); //JSP que ir� acessar.
	...
	public ModelAndView clientes(HttpServletRequest request, HttpServletResponse response, @RequestParam(value = "nome", required = false, defaultValue = "Henrique Brandao") String nome) { //Fun��o e alguns valores que recebe...
		String link = "/pages/deslogar";
		HttpSession session = request.getSession();
		ModelAndView modelAndView = new ModelAndView(link);
		String atualizarPagina = "";
	...
	public ModelAndView produtos(HttpServletRequest request, HttpServletResponse response, @RequestParam(value = "nome", required = false, defaultValue = "Henrique Brand�o") String nome) { //Fun��o e alguns valores que recebe...
		String link = "/pages/deslogar";
		HttpSession session = request.getSession();
		ModelAndView modelAndView = new ModelAndView(link);
		String atualizarPagina = "";
		...
		if(usuarioSessao != null && usuarioSessao.getID() != null) {
			link = "/pages/produtos"; //Link do JSP
			modelAndView = new ModelAndView(link); //JSP que ir� acessar atrav�s do link selecionado.
	...
	public ModelAndView categorias(HttpServletRequest request, HttpServletResponse response, @RequestParam(value = "nome", required = false, defaultValue = "Henrique Brand�o") String nome) { //Fun��o e alguns valores que recebe...
		String link = "/pages/deslogar";
		HttpSession session = request.getSession();
		ModelAndView modelAndView = new ModelAndView(link);
		String alerta = "";
		...
		if(usuarioSessao != null && usuarioSessao.getID() != null) {
			link = "/pages/categorias"; //Link do JSP
			modelAndView = new ModelAndView(link); //JSP que ir� acessar atrav�s do link selecionado.
			List<Categoria> categorias = categoriaDao.buscarAtivos();
			modelAndView.addObject("categorias", categorias); //Variavel produtos enviada ao JSP.
			enviaMsg(modelAndView); //** Obrigat�rio: para enviar alertas.
	...
	public ModelAndView perfil(HttpServletRequest request, HttpServletResponse response, @RequestParam(value = "nome", required = false, defaultValue = "Henrique Brand�o") String nome) { //Fun��o e alguns valores que recebe...
		String link = "/pages/deslogar";
		HttpSession session = request.getSession();
		ModelAndView modelAndView = new ModelAndView(link);
		String alerta = "";
		...
		if(usuarioSessao != null && usuarioSessao.getID() != null) {
			link = "/pages/perfil"; //Session
			modelAndView = new ModelAndView(link); //JSP que ir� acessar.
			List<Perfil> perfis = perfilDao.ativos();
			 // Verifica a sess�o e a msg de Bem-Vindo
			enviaMsg(modelAndView);
	...
	public ModelAndView deletando(HttpServletRequest request, HttpServletResponse response, @PathVariable("tabela") String tabela, @PathVariable("id") String id) { //Fun��o e alguns valores que recebe...
		...
		if(usuarioSessao != null && usuarioSessao.getID() != null) {
			Perfil perfildaSessao = perfilDao.findById(Integer.parseInt(""+usuarioSessao.getPerfil().getPerfilID())).get();
			link = "/pages/"+tabela; //Session
			modelAndView = new ModelAndView(link); //JSP que ir� acessar.
			...
			if(perfildaSessao.getAdmin()) {
				switch (tabela) {  
			       ...
			       case "funcionario" :   
			    	   ...
			    	   link = "/pages/funcionarios"; //Como tem uma tabela que trata cliente e funcionario devo explicar onde direcionar
			    	   modelAndView = new ModelAndView(link);
			       ...
			       case "cliente" :   
			    	   ...
			    	   registraMsg("Usuário", "Deletado com sucesso.", "erro");
			    	   link = "/pages/clientes"; //Como tem uma tabela que trata cliente e funcionario devo explicar onde direcionar
			    	   modelAndView = new ModelAndView(link);
			       ...
			       case "produto" :   
			    	   ...
			    	   link = "/pages/produtos"; //Como tem uma tabela que trata cliente e funcionario devo explicar onde direcionar
			    	   modelAndView = new ModelAndView(link);
			       ...
			       case "categoria" :   
			    	   ...
			    	   link = "/pages/categorias"; //Como tem uma tabela que trata cliente e funcionario devo explicar onde direcionar
			    	   modelAndView = new ModelAndView(link);
			       ...
			       case "venda" :   
			    	   ...
			    	   link = "/pages/todasVendas"; //Como tem uma tabela que trata cliente e funcionario devo explicar onde direcionar
			    	   modelAndView = new ModelAndView(link);
	...
	public ModelAndView produto(HttpServletRequest request, HttpServletResponse response, Produto produto, String produto_categoria, String alterarSalvar) { //Fun��o e alguns valores que recebe...
		String link = "/pages/deslogar";
		HttpSession session = request.getSession();
		ModelAndView modelAndView = new ModelAndView(link);
		String atualizarPagina = "";
	...
	public ModelAndView funcionario(HttpServletRequest request, HttpServletResponse response, Usuario usuario, String permissaoFunc) { //Fun��o e alguns valores que recebe...
		String link = "/pages/deslogar";
		HttpSession session = request.getSession();
		ModelAndView modelAndView = new ModelAndView(link);
		String atualizarPagina = "";
	...
	public ModelAndView perfil(HttpServletRequest request, HttpServletResponse response, Perfil perfil, String permissao) { //Fun��o e alguns valores que recebe...
		String link = "/pages/deslogar";
		HttpSession session = request.getSession();
		ModelAndView modelAndView = new ModelAndView(link);
		String atualizarPagina = "";
	...
	public ModelAndView atualizarPerfil(HttpServletRequest request, HttpServletResponse response, Perfil perfil, String permissao) { //Fun��o e alguns valores que recebe...
		//Deletando ID de alguma tabela que recebo.
		String link = "/pages/deslogar";
		HttpSession session = request.getSession();
		ModelAndView modelAndView = new ModelAndView(link);
	...
	public ModelAndView atualizarUsuario(HttpServletRequest request, HttpServletResponse response, Usuario usuario, String permissaoFunc, String codigoFunc, String senhaRepetida, String alterarSalvar, String funcCliente) { //Fun��o e alguns valores que recebe...
		//Deletando ID de alguma tabela que recebo.
		String link = "/pages/deslogar";
		HttpSession session = request.getSession();
		ModelAndView modelAndView = new ModelAndView(link);
	...
	public ModelAndView atualizarProduto(HttpServletRequest request, HttpServletResponse response, Produto produto, String alterarSalvar, String produto_categoria) { //Fun��o e alguns valores que recebe...
		//Deletando ID de alguma tabela que recebo.
		String link = "/pages/deslogar";
		HttpSession session = request.getSession();
		ModelAndView modelAndView = new ModelAndView(link);
	...
	public ModelAndView atualizarCategoria(HttpServletRequest request, HttpServletResponse response, Categoria categoria, String alterarSalvar, String permissao) { //Fun��o e alguns valores que recebe...
		//Deletando ID de alguma tabela que recebo.
		String link = "/pages/deslogar";
		HttpSession session = request.getSession();
		ModelAndView modelAndView = new ModelAndView(link);
	...
	public ModelAndView categoria(HttpServletRequest request, HttpServletResponse response, Categoria categoria, String permissao) { //Fun��o e alguns valores que recebe...
		String link = "/pages/deslogar";
		HttpSession session = request.getSession();
		ModelAndView modelAndView = new ModelAndView(link);
		String atualizarPagina = "";
	...
	public ModelAndView finalizaVenda(HttpServletRequest request, HttpServletResponse response, String pedidoVenda, String notaDataVenda, String valorTotalVenda, String vendas) { //Fun��o e alguns valores que recebe...
		String link = "/pages/deslogar";
		HttpSession session = request.getSession();
		ModelAndView modelAndView = new ModelAndView(link);
		String atualizarPagina = "";
	...
	public ModelAndView uploadExcel(HttpServletRequest request, HttpServletResponse response, String tabelaUsada, @ModelAttribute MultipartFile file) throws Exception, IOException { //Fun��o e alguns valores que recebe...
		String link = "/pages/deslogar";
		HttpSession session = request.getSession();
		ModelAndView modelAndView = new ModelAndView(link);
		String atualizarPagina = "";
